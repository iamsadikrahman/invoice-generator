            ...
            <table class="table-auto w-full">
                ...
                <tr v-for="(item,index) in data.items" :key="index">
                    ...
                    <td class="py-1  text-right text-gray-800">
                       <button @click="data.items.splice(index,1)"  class="border border-gray-400 bg-gray-300 hover:bg-gray-400 hover:text-white text-gray-800 font-bold py-2 px-4 rounded" type="button">Remove</button>
                    </td>
                </tr>
            </table>
